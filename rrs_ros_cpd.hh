...
public:
  ...
  void chatterCallbackEEFFranka(const geometry_msgs::Pose msg);
  void chatterCallbackStatusFranka(const sensor_msgs::JointState msg);
  ...
  std::shared_ptr<Net2Publisher> publisher_joint_status_franka;
  std::shared_ptr<Net2Publisher> publisher_franka_mode;
  std::shared_ptr<Net2Publisher> publisher_eef_franka;
  ...
  ros::Subscriber sub_franka_eef;
  ros::Subscriber sub_franka_status;
